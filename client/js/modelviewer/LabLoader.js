...
define([
    ...
    function(
        ...
        var LabLoader = function(viewerClient) {
            ...
            var tick = function(e) {
                ...
                for (var i = 0; i < pieces.length; i++) {
                    ...
                    pieces[i].updatePieceVisuals(evt.args(e).tpf);
        ...
        LabLoader.prototype.loadLevel = function(id, value) {
        ...
        LabLoader.prototype.toggleApp = function(src, value) {
