...
var CollisionDetection = function() {
    ...
    this.calcVec4 = new THREE.Vector3(0, 0, 0);
    this.calcVec5 = new THREE.Vector3(0, 0, 0);
    this.calcVec6 = new THREE.Vector3(0, 0, 0);
    ...
    CollisionDetection.prototype.checkIntersection = function(pieceA, pieceB, storePos, storeNorm) {
    ...
    CollisionDetection.prototype.fastPieceAgainstSlowPiece = function(fastPiece, slowPiece,  storePos, storeNorm) {
